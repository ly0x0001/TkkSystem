...
- (void) drawPlaceholderInRect:(CGRect)rect {
    ...
    self.placeholderLabel = [[UILabel alloc] initWithFrame:CGRectMake(rect.origin.x,
                                                                          ...
                                                                          rect.size.width,
                                                                          self.font.pointSize)];
    self.placeholderLabel.center = CGPointMake(self.placeholderLabel.center.x, self.frame.size.height - self.lineView.frame.size.height - self.placeholderLabel.frame.size.height / 2.f - 5.f);
...
- (void) didBeginChangeTextField {
    ...
    if (!self.isLifted) {
        [UIView animateWithDuration:[self animationDurationSet] animations:^{
            ...
            self.placeholderLabel.center = CGPointMake(self.placeholderLabel.center.x, self.placeholderLabel.frame.size.height - self.font.pointSize);
